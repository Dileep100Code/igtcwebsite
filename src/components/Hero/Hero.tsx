...
const esportsQuotes = [
  "OUR MISSION IS TO TAKE ESPORTS FROM LOCAL TO GLOBAL",
  "CHAMPIONS ARE MADE IN THE ARENA OF COMPETITION",
  "WHERE LEGENDS ARE BORN AND VICTORIES ARE EARNED",
  "DOMINATE THE GAME, CONQUER THE WORLD"
];
